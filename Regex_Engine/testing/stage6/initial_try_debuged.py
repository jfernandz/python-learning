# Debuged version to see what is the script doing with strings
# at every moment. Debug can be disabled by switching the
# the main_func() call for main_func(False) at the end
